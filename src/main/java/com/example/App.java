...
public class App {
    private static final String REMOTE_HOST = "ADDRESS_FOR_SFTP";
    private static final String USERNAME = "SFTP_USERNAME";
    private static final String PASSWORD = "SFTP_PASSWORD";
    private static final int PORT = 22;
    private static final String UPLOAD_DIR = "PATH-TO-FOLDER CONTAINING-CLASSERV.PY";
    private static final String ENDPOINT_URL = "SAME-AS-REMOTE_HOST";
    // Do not change this one, it will not take a picture with your webcam if you do! 
    ...
    public static void main(String[] args) throws IOException, AWTException {
        ...
        while (true) {
            ...
            System.out.println("NutriMind Lightweight - V0.1 Beta 1");
            ...
            switch (choice) {
                case 1:
                    // Execute the Python script for capturing an image with the webcam (I tried doing it in Java but I got neither Sarxos or OpenCV working. :( )
                    executePythonScript();
                ...
                case 2:
                 ...
                 if (response.equals("y") || response.equals("yes")) {
                    try {
                        String apiKey = "EXAMPLE-KEY"; // Replace with your actual API key
